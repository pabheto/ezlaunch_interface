...
import AccordionBasic from '@/shared/components/accordion-basic'
import AccordionTableItem from '@/shared/components/accordion-table-item'
import AccordionTableRichItem from '@/shared/components/accordion-table-rich-item'
