...
import PaginationNumeric from '@/shared/components/pagination-numeric'
import PaginationClassic from '@/shared/components/pagination-classic'
import PaginationNumeric02 from '@/shared/components/pagination-numeric-2'
